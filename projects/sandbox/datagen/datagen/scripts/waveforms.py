...
def main(
    ...
    """
    Simulates a set of BBH plus and cross polarizations
    and saves them to an output file.

    Args:
        prior: A function that returns a Bilby PriorDict when called
        num_signals: Number of waveforms to simulate
        datadir: Directory to which the waveforms will be written
        ...
        sample_rate: Sample rate at which the waveforms will be simulated
        waveform_duration: Length of the waveforms in seconds
