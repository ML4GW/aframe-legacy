...
def main(
    ...
    **kwargs,
    ...
    Args:
        ...
        kernel_length: Length of segment in seconds that the networks sees
        ...
        fduration: Length of the time-domain whitening filter in seconds
        psd_length: Length of background time in seconds to use for
            PSD calculation
        fftlength: Length of time in seconds to use to calculate the FFT
            during whitening
