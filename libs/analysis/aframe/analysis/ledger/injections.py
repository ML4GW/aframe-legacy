...
class IntrinsicParameterSet(Ledger):
    ...
    total_mass: np.ndarray = parameter()
    chirp_mass: np.ndarray = parameter()
    mass_ratio: np.ndarray = parameter()
    symmetric_mass_ratio: np.ndarray = parameter()
    mass_1_source: np.ndarray = parameter()
    mass_2_source: np.ndarray = parameter()
